...
def windowed_data_iteratively(data1, data2, time_bin, window_size):
    ...
    # Reshape data to combine features and time dimensions
...
def process_participant(participant, base_dir="data/experiment_2"):
    ...
    # Save results as CSV
    np.savetxt(f"{participant}_w20_Sliding_Window_Flattening_1v2.csv", all_accuracies_1v2, delimiter=",", header="Accuracy_1v2", comments="")
    np.savetxt(f"{participant}_w20_Sliding_Window_Flattening_1v3.csv", all_accuracies_1v3, delimiter=",", header="Accuracy_1v3", comments="")
    np.savetxt(f"{participant}_w20_Sliding_Window_Flattening_2v3.csv", all_accuracies_2v3, delimiter=",", header="Accuracy_2v3", comments="")
    ...
    np.savetxt(f"{participant}_w20_Sliding_Window_Flattening_mean_1v2.csv", mean_accuracies_1v2, delimiter=",", header="Mean_Accuracy_1v2", comments="")
    np.savetxt(f"{participant}_w20_Sliding_Window_Flattening_mean_1v3.csv", mean_accuracies_1v3, delimiter=",", header="Mean_Accuracy_1v3", comments="")
    np.savetxt(f"{participant}_w20_Sliding_Window_Flattening_mean_2v3.csv", mean_accuracies_2v3, delimiter=",", header="Mean_Accuracy_2v3", comments="")
    ...
    plt.savefig(f"{participant}_w20_Sliding_Window_Flattening.png")
    plt.show()
