...
def minirocket(X):
    ...
    minirocket.fit(X)
    X_transformed = minirocket.transform(X)
...
def evaluate_over_time(data1, data2, time_bins, stimulus_numbers1, stimulus_numbers2):
    ...
    for t in time_bins:
        ...
        X_transformed_pca = minirocket(X)
...
participants = ["P03", "P07", "P10", "P11", "P12"]
...
def process_participant(participant):
    ...
    # Save results as CSV
    np.savetxt(f"{participant}_w20_MiniRocket_1v2.csv", all_accuracies_1v2, delimiter=",", header="Accuracy_1v2", comments="")
    np.savetxt(f"{participant}_w20_MiniRocket_1v3.csv", all_accuracies_1v3, delimiter=",", header="Accuracy_1v3", comments="")
    np.savetxt(f"{participant}_w20_MiniRocket_2v3.csv", all_accuracies_2v3, delimiter=",", header="Accuracy_2v3", comments="")
    ...
    np.savetxt(f"{participant}_w20_MiniRocket_mean_1v2.csv", mean_accuracies_1v2, delimiter=",", header="Mean_Accuracy_1v2", comments="")
    np.savetxt(f"{participant}_w20_MiniRocket_mean_1v3.csv", mean_accuracies_1v3, delimiter=",", header="Mean_Accuracy_1v3", comments="")
    np.savetxt(f"{participant}_w20_MiniRocket_mean_2v3.csv", mean_accuracies_2v3, delimiter=",", header="Mean_Accuracy_2v3", comments="")
    ...
    plt.savefig(f"{participant}_w20_MiniRocket.png")
    plt.show()
