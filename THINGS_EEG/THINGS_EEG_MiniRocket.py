...
if __name__ == "__main__":
    ...
    np.savetxt("/data/z5452142/experiment_object/Overal_w20_MiniRocket_mean.csv", overall_mean_object_accuracy, delimiter=",")
    np.savetxt("/data/z5452142/experiment_object/Overal_w20_MiniRocket_ci.csv", ci, delimiter=",")
