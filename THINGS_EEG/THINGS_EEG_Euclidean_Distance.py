...
def process_participant(participant):
    ...
    for i in range(len(object_labels)):
        for j in range(i + 1, len(object_labels)):
            ...
            np.savetxt(os.path.join(data_path, f"{participant}_w20_Euclidean_Distance_{key}.csv"), acc, delimiter=",")
    ...
    np.savetxt(os.path.join(data_path, f"{participant}_w20_Euclidean_Distance_mean.csv"), mean_object_accuracy, delimiter=",")
...
if __name__ == "__main__":
    ...
    np.savetxt("/data/z5452142/experiment_object/Overal_w20_Euclidean_Distance_mean.csv", overall_mean_object_accuracy, delimiter=",")
    np.savetxt("/data/z5452142/experiment_object/Overal_w20_Euclidean_Distance_ci.csv", ci, delimiter=",")
