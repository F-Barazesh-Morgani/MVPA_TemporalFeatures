...
def process_participant(participant):
    ...
    for pair_key, acc_list in mean_accuracies.items():
        ...
        np.savetxt(os.path.join(data_path, f"{participant}_w20_Euclidean_Distance_mean_{pair_key}.csv"), mean_acc, delimiter=",")
    ...
    np.savetxt(os.path.join(data_path, f"{participant}_w20_Euclidean_Distance_mean.csv"), mean_hue_accuracy, delimiter=",")
...
if __name__ == "__main__":
    ...
    np.savetxt("/data/z5452142/experiment_hue/Overal_w20_Euclidean_Distance_mean.csv", overall_mean_hue_accuracy, delimiter=",")
    np.savetxt("/data/z5452142/experiment_hue/Overal_w20_Euclidean_Distance_ci.csv", ci, delimiter=",")
    ...
    plt.tight_layout()
    plt.savefig("Overall_w20_Euclidean_Distance.png")
    plt.show()
