...
def process_participant(participant):
    ...
    for pair_key, acc_list in mean_accuracies.items():
        ...
        np.savetxt(os.path.join(data_path, f"{participant}_w20_Sliding_Window_Flattening_mean_{pair_key}.csv"), mean_acc, delimiter=",")
    ...
    np.savetxt(os.path.join(data_path, f"{participant}_w20_Sliding_Window_Flattening_mean.csv"), mean_hue_accuracy, delimiter=",")
...
if __name__ == "__main__":
    ...
    np.savetxt("/data/z5452142/experiment_hue/Overal_w20_Sliding_Window_Flattening_mean.csv", overall_mean_hue_accuracy, delimiter=",")
    np.savetxt("/data/z5452142/experiment_hue/Overal_w20_Sliding_Window_Flattening_ci.csv", ci, delimiter=",")
